      ...
      <Container className="max-w-4xl">
        ...
        <div className="d-flex flex-column gap-2 mt-2" style={darkText}>
          <span className="d-flex align-items-center gap-2">
            <Mail size={18} /> <strong>Email</strong>: info@makemyvid.io
          </span>
          <span className="d-flex align-items-center gap-2">
            <Phone size={18} /> <strong>Phone (India)</strong>: +91 79774 84292
          </span>
          <span className="d-flex align-items-center gap-2">
            <Phone size={18} /> <strong>Phone (UK Enquiries)</strong>: +44 75425 50969
          </span>
          <span className="d-flex align-items-center gap-2">
            <MapPin size={18} /> <strong>Office Address</strong>: 11, Star Trade Centre, Chamunda Circle, Sodawala Lane, Borivali West, Mumbai 400092
          </span>
        </div>
...
<h2 className="fs-4 fw-semibold mt-5 pt-3 mb-3 d-flex align-items-center gap-2" style={headingColor}>
  <User size={28} /> 2. Information We Collect About You
</h2>
...
<h2 className="fs-4 fw-semibold mt-5 pt-3 mb-3 d-flex align-items-center gap-2" style={headingColor}>
  <Key size={28} /> 3. How We Use Your Information
</h2>
<p style={darkText} className="mb-4">
...
<h2 className="fs-4 fw-semibold mt-5 pt-3 mb-3 d-flex align-items-center gap-2" style={headingColor}>
  <Cookie size={28} /> 4. Cookies and Tracking Technologies
</h2>
...
<h2 className="fs-4 fw-semibold mt-5 pt-3 mb-3 d-flex align-items-center gap-2" style={headingColor}>
  <Megaphone size={28} /> 5. Marketing and Advertising
</h2>
<p style={darkText} className="mb-3">
...
<h2 className="fs-4 fw-semibold mt-5 pt-3 mb-3 d-flex align-items-center gap-2" style={headingColor}>
  <Settings size={28} /> 6. Use of Automated Systems
</h2>
<p style={darkText} className="mb-3">
...
<h2 className="fs-4 fw-semibold mt-5 pt-3 mb-3 d-flex align-items-center gap-2" style={headingColor}>
  <Database size={28} /> 7. Retention of Your Information
</h2>
<p style={darkText} className="mb-3">
...
<h2 className="fs-4 fw-semibold mt-5 pt-3 mb-3 d-flex align-items-center gap-2" style={headingColor}>
  <Share size={28} /> 8. Sharing Your Information
</h2>
<p style={darkText} className="mb-3">
...
<h2 className="fs-4 fw-semibold mt-5 pt-3 mb-3 d-flex align-items-center gap-2" style={headingColor}>
  <Globe size={28} /> 9. International Data Transfers
</h2>
<p style={darkText} className="mb-4">
...
{/* 11. Your Rights */}
<h2 className="fs-4 fw-semibold mt-5 pt-3 mb-3 d-flex align-items-center gap-2" style={headingColor}>
  <UserCheck size={28} /> 11. Your Rights
</h2>
<p style={darkText} className="mb-3">
...
<h2 className="fs-4 fw-semibold mt-5 pt-3 mb-3 d-flex align-items-center gap-2" style={headingColor}>
  <RefreshCw size={28} /> 12. Changes to This Privacy Policy
</h2>
<p style={darkText} className="mb-3">
