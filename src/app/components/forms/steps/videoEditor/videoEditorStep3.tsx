          ...
          <div className="row">
            ...
            <div className="col-md-6">
              ...
              <div className="input-group-meta position-relative uniform-height">
                <input
                  type="file"
                  accept="image/png, image/jpeg, image/jpg, image/gif, application/pdf, application/msword, application/vnd.openxmlformats-officedocument.wordprocessingml.document, text/plain" // --- MODIFIED: Specify accepted formats
