// steps/video-editor/VideoEditorStep1.tsx
"use client";
...
// Only editorBaseSkills are needed here
...
const videoEditorStep1: React.FC<Props> = ({ formData, setFormData, nextStep }) => {
  ...
  // We explicitly use 'base_skills' from formData for video editor skills.
  ...
  // Filter based only on editorBaseSkills
  const filtered: string[] = (editorBaseSkills || []).filter(
  ...
  return (
    <div>
      <h4 className="mb-3">Register as a Video Editor</h4> {/* Updated title */}
...
<div className="input-group-meta position-relative mb-25">
      ...
      {/* Skills section - always visible for video editor */}
