...
const VideographerStep1: React.FC<Props> = ({ formData, nextStep }) => {
  ...
  // 2. Added state for confirm password
  const [showConfirmPassword, setShowConfirmPassword] = useState(false);

  // 3. Watch password field for comparison
          ...
          <div className="input-group-meta position-relative mb-25">
            ...
            <span 
              ...
              style={{
                position: 'absolute',
                right: '15px',
                top: '85%', // 6. Matched style from previous files
          ...
          <div className="input-group-meta position-relative mb-25">
            ...
            <span 
              ...
              style={{
                position: 'absolute',
                right: '15px',
                top: '65%', // 6. Matched style from previous files
                transform: 'translateY(-50%)',
                cursor: 'pointer'
              }}
            >
