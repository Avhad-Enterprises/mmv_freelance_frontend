...
import apple from "@/assets/images/icon/apple.png"; // 🍎 added

interface SaveJobLoginModalProps {
  onLoginSuccess: () => void;
}

const SaveJobLoginModal: React.FC<SaveJobLoginModalProps> = ({ onLoginSuccess }) => {
  return (
    <div
      className="modal fade"
      id="saveJobLoginModal"
      tabIndex={-1}
      aria-hidden="true"
      aria-labelledby="saveJobLoginModalLabel"
    >
...
export default SaveJobLoginModal;