...
const faqContent = {
  ...
  forClients: [
    { id: 'fc1', title: 'How do I post a video project on MakeMyVid.io?', desc: 'Simply click "Post a Project," and our intuitive form will guide you. Be sure to describe your project clearly, including the type of video (e.g., corporate video, YouTube content), required skills, budget, and timeline to attract the best freelance video talent.' },
    { id: 'fc2', title: 'Is it really free to post a project?', desc: 'Yes, it is 100% free for clients to post a project. You will only pay for the work you commission once you hire a freelancer and approve the project milestones or final delivery. There are no hidden fees to find a video editor.' },
    { id: 'fc3', title: 'How do I find the right freelance videographer or video editor?', desc: 'You can either post a project and receive proposals, or you can browse our directory of vetted video creators. Use filters to search by skill (e.g., "After Effects," "Final Cut Pro"), specialty ("wedding film editor," "Reels editor"), location, and budget.' },
    ...
    { id: 'fc11', title: 'What if I need a full team, like a videographer and an editor?', desc: 'You can easily hire multiple freelancers for a single project. You can post a project for a video production team or hire individual specialists for shooting and post-production separately through our platform.' },
  ],
  forFreelancers: [
