    ...
    <div className="dashboard-body">
      <div className="position-relative">
        ...
        <div className="bg-white card-box border-20">
          <div className="bg-white card-box border-20">
            <div className="user-avatar-setting d-flex align-items-center mb-30">
              {/* Avatar Image */}
              <img
                src={profilePic || blankAvatar.src}
                alt="avatar"
              ...
              {/* <div className="upload-btn position-relative tran3s ms-4 me-3"> */}
                ...
                <FileUploadComponent
                  ...
                  onChange={(files: { file: File; isValid: boolean; fileUrl: string | null }[]) => {
                    if (files && files.length > 0 && files[0].fileUrl) {
                      setProfilePic(files[0].fileUrl); //AWS se URL set hoga
                    } else {
                      setProfilePic(null);
                    }
                  }}
        ...
        <div className="button-group d-inline-flex align-items-center mt-30">
          <button onClick={handleSave} className="dash-btn-two tran3s me-3">
            Save
          </button>
