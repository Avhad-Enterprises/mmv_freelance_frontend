    ...
    try {
        ...
        if (result.success && result.data) {
            ...
            if (approved) {
                ...
                console.warn('No approved submission found in data:', result.data);
                toast.error("No approved submission found for this project.");
            }
        } else {
    ...
    <div className="dashboard-body">
      <div className="position-relative">
        ...
        <div className="d-flex justify-content-between align-items-center mb-4">
            <h2 className="main-title mb-0">Approved Projects</h2>
        </div>
            ...
            <div className="modal-dialog modal-dialog-centered modal-lg">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">Approved Project Details</h5>
                    ...
                    <div className="modal-body">
                        ...
                        {loadingSubmission ? (
                            ...
                            <>
                                <div className="d-flex align-items-center mb-4 p-3 bg-light rounded">
                                    ...
                                    <div className="ms-auto">
                                        <span className="badge bg-success">Approved on {new Date(approvedSubmission.updated_at || approvedSubmission.created_at).toLocaleDateString()}</span>
                                    </div>
                                </div>
                            ...
                            <div className="alert alert-warning">No approved submission details found.</div>
                        )}
                    </div>
...
export default ApprovedProjectsArea;
