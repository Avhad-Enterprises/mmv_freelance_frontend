...
import { fetchCandidateByUsername } from '@/redux/features/candidateDetail';
...
const ActionDropdown = ({ id, username, favoriteFreelancerId, onDeleted }: Props) => {
  ...
  const handleView = () => {
    dispatch(fetchCandidateByUsername(username));
    router.push(`/candidate-profile/${username}`);
  };
