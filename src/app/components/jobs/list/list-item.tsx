      ...
      <div className="row justify-content-between align-items-center">
        <div className="col-xxl-3 col-lg-4">
          <div className="job-title d-flex align-items-center">
            <Link href={`/job-details/${id}`} className="logo">
              <Image src={logo} alt="logo" className="lazy-img m-auto" />
            </Link>
            <Link href={`/job-details/${id}`} className="title fw-500 tran3s">
              {title}
            </Link>
          </div>
        </div>
        <div className="col-lg-3 col-md-4 col-sm-6 ms-auto">
          ...
          <div className="job-date">
            {date} by <Link href={`/job-details/${id}`}>{company}</Link>
          </div>
        </div>
        <div className="col-xxl-2 col-lg-3 col-md-4 col-sm-6 ms-auto xs-mt-10">
          <div className="job-location">
            <Link href={`/job-details/${id}`}>{location}</Link>
          </div>
