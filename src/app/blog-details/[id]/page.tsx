...
import JobPortalIntro from "../../components/job-portal-intro/job-portal-intro"; // Adjusted path
import CompanyBreadcrumb from "../../components/common/common-breadcrumb"; // Adjusted path
