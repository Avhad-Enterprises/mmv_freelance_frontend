...
import logo_2 from "@/assets/images/logo/logo_new.png";
import logo_w from "@/assets/images/logo/logo_new.png";
						...
						<div className="col-lg-2 col-md-3 footer-intro mb-15">
							<div className="logo mb-15">
								<Link href="/" className="d-flex align-items-center">
									<Image src={style_2 ? logo_w : style_3 ? logo_2 : logo} alt="logo" width={120} height={60} priority />
								</Link>
							</div>
							<Image
								src={shape}
